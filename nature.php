...
<html class="js gr__petervanalphen_com cssanimations" lang="en">
    <head>
        ...
        <title>Black Lotus Photography - Nature</title>    
        ...
        <div id="barba-wrapper" aria-live="polite">
            <div class="barba-container page-category">
                <div class="frame-left">
                    <div class="frame-left-vertical">
                        <div class="breadcrumbs">
                            ...
                            <a href="/gallery.php/">
                                <div class="bread-item">
                                    <div class="bread-before">Gallery</div>
                                    <div class="bread-after">Gallery</div>
                                </div>
                            </a>
                            <div class="bread-arrow"></div>
                            <div class="bread-item" onMouseOver="this.style.cursor='auto'">
                                <div class="bread-before bread-no-hover" onMouseOver="this.style.cursor='auto'">Nature</div>
                                <div class="bread-after">Nature</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div id="wrapper">
                    ...
                    <div class="category">
                        <a href="/trees.php/">
                            <div class="img-container-opening">
                                <div class="discovery"><p>Trees</p></div>
                                <div class="discovery-arrow"></div>
                                <div class="category-img img-left"><img src="/assets/img/project/nature-1/trees/1.jpg"/></div>
                                <div class="category-img img-center"><img src="/assets/img/project/nature-1/trees/2.jpg"/></div>
                                <div class="category-img img-right"><img src="/assets/img/project/nature-1/trees/3.jpg"/></div>
                            </div>
                        </a>
                    </div>
                    <div class="category">
                    ...
                    <div class="category-bg bg-nature"></div>
                    <!-- ./Page Content -->
                </div>
            </div>
        </div>
